...
logger = logging.getLogger("desktopenv.providers.nvcf_enroot.NVCFEnrootVMManager")
logger.setLevel(logging.INFO)


class NVCFEnrootVMManager(VMManager):
    """Minimal VM manager for the enroot-backed OSWorld container provider."""
