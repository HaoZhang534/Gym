"""Lazy exports for OSWorld metric functions.

The original module imported every metric backend at package import time. That
made lightweight tasks depend on optional OCR, audio, PDF, and image packages
even when their evaluator only needed a simple text matcher.
"""
...
__all__ = sorted([*_METRIC_MODULES, "infeasible"])
...
def __getattr__(name):
    ...
    module_name = _METRIC_MODULES.get(name)
